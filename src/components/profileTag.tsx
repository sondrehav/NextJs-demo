  ...
  return (
    ...
    >
      {image && (
        <div
          className={
            "rounded-full flex-grow-0 flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 border-2 border-gray-800 shadow-lg overflow-hidden"
          }
        >
          <Image
            className={"w-full h-full object-cover"}
      ...
      {name && (
        <h3
          className={
            "text-sm sm:text-base leading-none sm:leading-normal flex-1"
          }
        >
          {name}
        </h3>
